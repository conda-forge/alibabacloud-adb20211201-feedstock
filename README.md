About alibabacloud-adb20211201-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/alibabacloud-adb20211201-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/alibabacloud-adb20211201-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add alibabacloud-adb20211201
# for installing globally
pixi global install alibabacloud-adb20211201
```
...
It is possible to list all of the versions of `alibabacloud-adb20211201` available on your platform:
...
```
pixi search alibabacloud-adb20211201 --channel conda-forge
```
